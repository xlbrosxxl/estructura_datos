...
public class SinglyLinkedList<T> {
    ...
    /**
     * TODO: Complete Method add a node at the end of the list
     *
     * @param nodeToInsert
     */
    ...
    /**
     * TODO: Complete method delete a node from the list given its position
     *
     * @param pos
     */
    void deleteNode(int pos) {
        ...
        if (!isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "La lista esta vacia, agregue elementos");
        }
